...
export const DIARIO_SCAN_MAX_BATCHES = clampInt(process.env.MCP_DIARIO_SCAN_MAX_BATCHES, 4, 1, 50);
export const DIARIO_SCAN_TIME_BUDGET_MS = clampInt(process.env.MCP_DIARIO_SCAN_TIME_BUDGET_MS, 70000, 5000, 300000);
